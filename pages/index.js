    ...
    <Layout>
      ...
      >
        <div className="absolute top-20 left-4">
          <img src="/logo.jpg" alt="Logo" className="w-24 h-24 md:w-32 md:h-32" />
        </div>
        <div className="flex flex-col items-center justify-center h-full bg-black bg-opacity-50 p-4">
          ...
          <p className="text-lg md:text-2xl text-white text-center">I am Siraw Tadesse, Full-Stack Software Developer</p>
        </div>
      </section>
      ...
      <section id="about" className="flex flex-col md:flex-row p-10 items-center">
        <div className="md:w-96">
          <img src="/srw.jpg" alt="Siraw Tadesse" className="w-max-w-4xl h-80 rounded-lg shadow-lg" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {projects.map((project, index) => (
            <div key={index} className="bg-gray-100 p-5">
              ...
              <a href={project.github} target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">View on GitHub</a>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="experience" className="p-10 bg-gray-100">
        ...
        <div className="space-y-6 md:flex md:space-x-6 md:justify-center">
      ...
      <section id="skills" className="p-10 bg-gray-200">
        ...
        <div className="flex flex-wrap justify-center space-x-4">
          {['HTML CSS JS', 'Reactjs, Nextjs, Angular', 'Python - Django, Flask', 'PHP - Laravel', 'Mysql', 'Data analysis - Python', 'Computer Network Config.', 'IP Camera Installation', 'Telegram Bot development'].map((skill, index) => (
            <div key={index} className="bg-white shadow-md rounded-lg p-5 w-32 mb-4">
        ...
        <div className="flex flex-col md:flex-row justify-center items-start space-x-10">
          <form className="bg-white shadow-md rounded-lg p-6 w-full max-w-lg">
            <div className="mb-4">
              ...
              <input type="text" id="name" placeholder="Your Name" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="email">Email</label>
              <input type="email" id="email" placeholder="Your Email" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required />
            </div>
            <div className="mb-4">
              <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="message">Message</label>
              <textarea id="message" rows="4" placeholder="Your Message" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required></textarea>
            </div>
